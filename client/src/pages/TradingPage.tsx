            ...
            <div className="grid gap-4 lg:grid-cols-[2fr_1fr]">
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-4">
                ...
                <div className="grid gap-2">
                  {["잔고 조회", "AI 시장 분석", "알림 만들기"].map((label) => (
                    <button key={label} className="rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-slate-200 hover:border-cyan-600/50 hover:text-cyan-300">
                      {label}
                    </button>
                  ))}
                </div>
