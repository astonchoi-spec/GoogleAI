...
function manualChunks(id: string) {
  ...
  if (id.includes("react-dom") || id.includes("react") || id.includes("wouter") || id.includes("next-themes")) {
    return "react-vendor";
  }
  ...
  if (id.includes("googleapis") || id.includes("@google/generative-ai") || id.includes("telegraf")) {
