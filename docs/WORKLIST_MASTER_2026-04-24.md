...
- current_focus: `Phase 2 realtime`
- progress: `12/27 completed`
...
2. Phase 2 realtime: `7-2` (completed), next `7-3`, `8`
...
- phase2: `3` completed, `12` pending
- phase3: `3` pending
- total: `27` tasks, `12` completed
